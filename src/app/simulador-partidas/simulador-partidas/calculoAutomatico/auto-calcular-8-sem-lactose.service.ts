...
export class AutoCalcular8SemLactoseService extends AutoCalcularBase{
  ...
  public autoCalcularSemLactose(acucar:number,
                                ...
                                snfButterOil:number) {
    this.correcoesIniciais(tfEsperado,snfLeiteIntegral,gorduraLeiteIntegral,acucar,esperadoSnf,snfPreIntegral,gorduraPreIntegral)
    ...
    return{leite:this.quantidadeLeiteIntegral,preIntegral:this.quantidadePreIntegral,preDesnatado:this.quantidadePreDesnatado,butterOil:this.quantidadeButterOil};
  }

  private correcoesIniciais(tfEsperado: number, snfLeite: number, gorduraLeite: number, acucar: number, esperadoSnf: number, snfPreIntegral: number, gorduraPreIntegral: number) {
